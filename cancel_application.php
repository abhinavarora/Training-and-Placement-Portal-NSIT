...
?>
<head>
<title>De-Register for a Company</title>
...
xmlhttp.onreadystatechange=function()
  ...
  if (xmlhttp.readyState==4 && xmlhttp.status==200)
	...
	temp = str.split('<span></span>');
    document.getElementById("information").innerHTML=temp[0]+temp[5]+temp[6];
    }
  }
...
function show_confirm(thisform)
{
delcompany= thisform.company.value;
if(delcompany=="NULL")
{
...
{
var r=confirm('Are you sure you want to cancel your application for ' + delcompany+'?');
return r;
}
}
</script>
...
<div class="inner-box clearfix">
				...
				<div id="sidebar">
					...
					<ul id='sidebar' class="main">
						...
						<li class="current"><a href="cancel_application.php">De-Register for Company</a></li>
		...
		<center>
	<h1 style="font-size: 30px; font-family:'Times New Roman', Times, serif;" >Cancel Application for Company<h1></center>
	<hr /><br /><br />
		<div id="form-block">
	<form action="deregister.php" onSubmit="return show_confirm(this)" method="post">
...
$result = mysql_query("SELECT * FROM companyapply WHERE student_rollnum='$username'");
...
<input type="submit" name="submit" value="Cancel Application" style="width:25%;font-size:15px;font-weight:normal;"  />
</form><br />
<p style="font-size:17px;font-weight:normal;">
<strong>NOTE : </strong>You can De-Register only for those companies whose Registerations are currently open.</p>
<br />
