...
<div id="form-block">
<form id="values" action="company_hrverify.php" method="post" enctype="multipart/form-data">
<?php
...
<p>Email ID: </p><input name="email" type="text" value="<?php echo $row['email'] ?>" size="70" />
...
<tr><td>
<a href="company_head.php"><img src="back.jpg" /></a></td><td>
