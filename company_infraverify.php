...
$name = $_SESSION['name'];
	  ...
	  $sql="UPDATE companyprofile SET days = '$days', executives = '$executives', rooms = '$rooms', otherinfra = '$otherinfra', loginstatus = '$status' 
WHERE username = '$name' ";
...
<B>HRA : </B>".$row['hra']."<br/><B>Gross : </B>".$row['gross']."<br/><B>Others : </B>".$row['othercompensation']."<br/><B>Take Home : </B>".$row['takehome']."<br/><B>Cost to Company : </B>".$row['cost']."<br/><B>Any further Details : </B>".$row['details'].
"<h3><U>Master of Technology (M.tech.)</U></h3>
<B>HRA : </B>".$row['mhra']."<br/><B>Gross : </B>".$row['mgross']."<br/><B>Others : </B>".$row['mothercompensation']."<br/><B>Take Home : </B>".$row['mtakehome']."<br/><B>Cost to Company : </B>".$row['mcost']."<br/><B>Any further Details : </B>".$row['mdetails'].
"<br/><br/><h2><U>BRANCHES ALLOWED</U></h2>
<h3><U>Bachelor of Engineering (B.E.)</U></h3>
<B>Electronics and Communication Engineering : </B>".$row['ece']."<br/><B>Computer Engineering : </B>".$row['cse']."<br/><B>Information Technology : </B>".$row['it']."<br/><B>Instrumentation & Control Engineering : </B>".$row['ice']."<br/><B>Manufacturing Process & Automation Engineering : </B>".$row['mpae']."<br/><B>Biotechnology : </B>".$row['bt'].
"<h3><U>Master of Technology (M.tech.)</U></h3>
...
$email_to1 = "placements@nsitonline.in"; // Who the email is too 
...
$ok1 = @mail($email_to1, $email_subject, $email_message, $headers); 
	  ...
	  echo "<p class='text'>YOUR COMPANY PROFILE WAS SUCCESSFULLY UPDATED</p>" ;
			echo '<meta http-equiv="Refresh" content="2;
			URL=companyview.php">';
